...
//        return $this->fetch('public/common_form');
        $field = [
            ...
            Form::frameImages('code_image','产品二维码(640*640px)',Url::build('admin/widget.images/index',array('fodder'=>'code_image')))->maxLength(5)->icon('images')->width('100%')->height('550px')->spin(0),
