        ...
        <div>
          ...
          <!-- 秒杀列表 -->
            ...
            <div class="buyspell-list" v-cloak="" v-show="combinationList.length > 0">
                ...
                <div class="product-banner"><a  href="<?php echo $pinkImageUrl; ?>" ><img src="<?php echo $pinkImage; ?>"></a></div>
            ...
            <div class="template-prolist" v-cloak="" v-for="item in cateGroupList" v-show="cateGroupList.length > 0">
                ...
                <div class="product-banner"><a  :href="item.pic_url" ><img :src="unThumb(item.pic)" v-show="item.pic != ''"></a></div>
                <ul class="flex">
