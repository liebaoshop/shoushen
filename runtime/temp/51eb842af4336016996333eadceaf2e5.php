<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\soft\www\wx_new/application/admin\view\order\store_order\express.php";i:1539052738;}*/ ?>
...
<div class="user-order-logistics" style="overflow: hidden;">
    <section>
        <div class="product-info flex">
            <div class="picture"><img src="/public/wap/first/crmeb/images/express_icon.jpg"/></div>
            <div class="logistics-tip flex">
                <div class="company">物流公司：<?php echo $order['delivery_name']; ?></div>
                <div class="number">物流单号：<?php echo $order['delivery_id']; ?></div>
            </div>
        </div>
        <div class="logistics-info" style="background-color: inherit;">
            ...
            <?php }else{ ?>
                <ul class="flex">
                    <?php if(is_array($express['result']['list']) || $express['result']['list'] instanceof \think\Collection || $express['result']['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $express['result']['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li class="clearfix">
