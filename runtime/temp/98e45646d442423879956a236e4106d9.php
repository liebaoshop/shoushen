            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        <div class="col-xs-6" >用户昵称: <?php echo $userInfo['nickname']; ?></div>
                        <div class="col-xs-6">收货人: <?php echo $orderInfo['real_name']; ?></div>
                        <div class="col-xs-6">联系电话: <?php echo $orderInfo['user_phone']; ?></div>
                        <div class="col-xs-6">收货地址: <?php echo $orderInfo['user_address']; ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        ...
                        <?php endif; if($orderInfo['deduction_price'] > 0): ?>
