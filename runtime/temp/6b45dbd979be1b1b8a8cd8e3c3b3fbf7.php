    ...
    <section>
        <div class="con-box">
            <div class="title">
                ...
                <span>发布时间：<?php echo date('Y-m-d H:i:s',$content['add_time']); ?></span> <span>作者：<?php echo $content['author']; ?></span> <span>浏览：<?php echo $content['visit']; ?></span>
            </div>
            <div class="con"><?php echo $content['content']; ?></div>
        </div>
    </section>
</div>
