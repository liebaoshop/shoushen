    ...
    <section>
        ...
        <div class="ewm-wrapper">
            <div class="ewm-picture" style="position: relative;">
                <img src="<?php echo $qrInfo['url']; ?>" />
                <img src="<?php echo $wechatUser['headimgurl']; ?>" style="width: 1rem;height: 1rem;position: absolute;left: 50%;top: 50%;margin-left: -.5rem;margin-top: -.5rem;" />
            </div>
            <div class="text-content">
                搜索微信公众号 <span><?=\service\SystemConfigService::get('site_name')?></span><br />
                或长按上方二维码立即关注
            </div>
            <div class="link"><a href="<?php echo Url('Index/index'); ?>">进入商城</a></div>
        </div>
...
<script>
    mapleWx($jssdk(),function(){
       this.onMenuShareAll({
           ...
           link:"<?php echo Url('Index/index',['spuid'=>$wechatUser['uid']],true,true); ?>"
       });
    });
</script>
