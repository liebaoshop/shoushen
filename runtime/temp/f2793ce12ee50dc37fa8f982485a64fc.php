                            ...
                            <div class="control-body">
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-sm-10 group-item">
                                        <input style="resize: none;width: 100%;padding:  6px 12px;" v-model="keyword" type="text" name="keyword" placeholder="请输入关键字" <?php if($key): ?>disabled="disabled"<?php endif; ?> />
                                    </div>
                                </div>
                                <div class="form-group clearfix">
        ...
        const vm = new Vue({
            ...
            methods: {
                submit: function(){
                    ...
                    window.vm = this;
                    $eb.axios.post("<?php echo Url('save_keyword',array('dis'=>$dis)); ?>",{key:this.keyword,status:this.status,data:this.dataGroup[this.type],type:this.type}).then(function(res){
