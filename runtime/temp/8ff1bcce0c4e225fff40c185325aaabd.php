                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('退款','<?php echo Url('edit',array('id'=>$vo['id'])); ?>',{h:'300',w:'500'})"><i class="fa fa-paste"></i> 退款</button>
                            </td>
                        </tr>
