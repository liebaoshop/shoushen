        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="alert alert-success alert-dismissable">
                    ...
                    目前拥有<?php echo $countBargain; ?>个砍价产品
                </div>
...
<!--                        <button class="layui-btn layui-btn-sm layui-btn-danger" type="button" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create'); ?>')"><i class="fa fa-check-circle-o"></i>添加砍价</button>-->
<!--                     </div>-->
