                ...
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        <?php switch($type): case "1": ?>
                                <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create'); ?>',{h:760,w:1100})">添加产品</button>
                            <?php break; case "2": ?>
                    ...
                    <script type="text/html" id="act">
                        ...
                        <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" onclick="$eb.createModalFrame('{{d.store_name}}-编辑','<?php echo Url('edit'); ?>?id={{d.id}}',{h:760,w:1100})">
                            编辑
                        </button>
