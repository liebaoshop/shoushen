...
<script>
    (function(){
        ...
        requirejs(['vue','store','helper','/public/wap/first/crmeb/module/store/use-coupon.js','/public/wap/first/crmeb/module/store/use-address.js','layer'],function(Vue,storeApi,$h,useCoupon,useAddress,layer){
            Vue.use(useCoupon);
            Vue.use(useAddress);
