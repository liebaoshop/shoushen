                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-primary btn-xs grant" data-url="<?php echo Url('ump.storeCouponUser/grant',array('id'=>$vo['id'],'uid'=>$uid)); ?>" type="button"><i class="fa  fa-arrow-circle-o-right"></i> 发放
                                </button>
                            </td>
                        </tr>
...
<script>
    $('.grant').on('click',function(){
        ...
        swal({
            title: "您确定要发放优惠券给‘<?php echo $nickname; ?>’吗？",
            text:"发放后将无法撤回，请谨慎操作！",
            type: "warning",
