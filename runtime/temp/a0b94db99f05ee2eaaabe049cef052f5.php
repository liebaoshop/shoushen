    ...
    <section>
        <div class="menu-wrapper border-1px" ref="head">
            ...
            <div class="menu-list flex">
                ...
                <?php if($picReplyCount >= '1'): ?>
                <a class="item" href="javascript:void(0);" :class="{active:type == 'pic'}" @click="type = 'pic'">有图(<?php echo $picReplyCount; ?>)</a>
                <?php endif; ?>
            </div>
        </div>
