<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"/web/wwwroot/demo2.5.crmeb.net/application/admin/view/setting/system_menus/index.php";i:1534566660;s:74:"/web/wwwroot/demo2.5.crmeb.net/application/admin/view/public/container.php";i:1538399107;s:75:"/web/wwwroot/demo2.5.crmeb.net/application/admin/view/public/frame_head.php";i:1538032256;s:70:"/web/wwwroot/demo2.5.crmeb.net/application/admin/view/public/style.php";i:1540348972;s:75:"/web/wwwroot/demo2.5.crmeb.net/application/admin/view/public/inner_page.php";i:1534566660;s:77:"/web/wwwroot/demo2.5.crmeb.net/application/admin/view/public/frame_footer.php";i:1534565810;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                ...
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create',array('cid'=>0)); ?>')">添加规则</button>
